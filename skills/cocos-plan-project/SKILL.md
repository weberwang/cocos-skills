...
- `implementation-plan.yaml` must carry frozen input versions and `sha256:` hashes and define scenes, prefabs, scripts, asset dependencies, `module_decomposition`, `dependency_graph`, `scene_loops`, tasks, ownership, the asset-approval join gate, and the one Cocos writer.
